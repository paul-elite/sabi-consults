        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-[#8b7355] text-white p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              <div className="flex gap-6 p-6 bg-[#f8f6f3]">
                <div className="text-4xl font-light text-[#8b7355]">01</div>
                <div>
              ...
              <div className="flex gap-6 p-6 bg-[#f8f6f3]">
                <div className="text-4xl font-light text-[#8b7355]">02</div>
                <div>
              ...
              <div className="flex gap-6 p-6 bg-[#f8f6f3]">
                <div className="text-4xl font-light text-[#8b7355]">03</div>
                <div>
              ...
              <div className="flex gap-6 p-6 bg-[#f8f6f3]">
                <div className="text-4xl font-light text-[#8b7355]">04</div>
                <div>
