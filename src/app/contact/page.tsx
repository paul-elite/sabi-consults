              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@sabiconsults.com" className="text-neutral-600 hover:text-[#8b7355] transition-colors">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+2348000000000" className="text-neutral-600 hover:text-[#8b7355] transition-colors">
                      +234 800 000 0000
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-[#f8f6f3] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#8b7355]" fill="currentColor" viewBox="0 0 24 24">
