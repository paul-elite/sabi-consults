          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {districts.slice(0, 8).map((district) => (
              <Link
                ...
                className="group bg-white p-6 hover:bg-[#1a1a1a] transition-colors duration-300"
              >
                <h3 className="text-lg font-medium text-[#1a1a1a] group-hover:text-white transition-colors">
                  {district.name}
                </h3>
                <p className="text-sm text-neutral-500 group-hover:text-neutral-400 mt-1 transition-colors">
      ...
      <section className="py-24 bg-[#f8f6f3]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-neutral-600 mb-8 max-w-2xl mx-auto">
            Whether you&apos;re buying, selling, or investing in Abuja real estate,
