...
function variationToForm(v: PropertyVariation): VariationForm {
  return {
    id: v.id,
    name: v.name,
    price: v.price?.toString() || '',
    bedrooms: v.bedrooms?.toString() || '',
    bathrooms: v.bathrooms?.toString() || '',
    bq: v.bq?.toString() || '',
    landSize: v.landSize?.toString() || '',
    unitsAvailable: v.unitsAvailable?.toString() || '',
...
export default function EditPropertyPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    async function fetchProperty() {
      try {
        ...
        if (property.variations && property.variations.length > 0) {
          setVariations(property.variations.map(variationToForm))
        }
      } catch {
  ...
  const updateVariation = (variationId: string, field: keyof VariationForm, value: string) => {
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white border border-neutral-200 p-6">
              ...
              <p className="text-sm text-neutral-500 mb-6">
                For estates with multiple unit types or plot sizes.
              </p>
            ...
            <div className="bg-white border border-neutral-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-neutral-500">
                  Coordinates are auto-filled from Google Maps link. You can also enter manually.
                </p>
              </div>
            </div>
