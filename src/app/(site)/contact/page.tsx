...
export const metadata: Metadata = {
  title: 'Contact Us | Sabi Consults',
  description: 'Get in touch with Sabi Consults for premium real estate services in Abuja, Nigeria.',
}
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-[#1a1a1a] mb-1">Office Location</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@sabiconsults.com" className="text-neutral-600 hover:text-[#0055CC] transition-colors">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-[#1a1a1a] mb-1">Call Us</h3>
                    <a href="tel:+2349160531000" className="text-neutral-600 hover:text-[#0055CC] transition-colors">
                      0916 053 1000
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-neutral-600 hover:text-[#0055CC] transition-colors"
                    >
                      Chat with us
                    </a>
                  </div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-[#f8f6f3] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#0055CC]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="font-medium text-[#1a1a1a] mb-1">Instagram</h3>
                    <a
              ...
              <div className="mt-12 pt-8 border-t border-neutral-200">
                <h3 className="font-medium text-[#1a1a1a] mb-4">Operating Hours</h3>
            ...
            {/* Contact Form */}
            <div className="bg-[#f8f6f3] p-8 lg:p-12">
