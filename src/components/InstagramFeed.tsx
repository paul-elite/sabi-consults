    ...
    return (
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Placeholder grid linking to Instagram */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
            {[...Array(6)].map((_, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#0055CC] opacity-0 group-hover:opacity-90 transition-opacity flex items-center justify-center">
          ...
          <div className="text-center mt-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white text-sm font-medium hover:opacity-90 transition-opacity"
            >
    ...
    return (
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
            {[...Array(6)].map((_, index) => (
              <div key={index} className="aspect-square bg-neutral-100 animate-pulse" />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
          {posts.map((post) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative aspect-square group overflow-hidden bg-neutral-100"
            >
              <Image
                src={post.mediaUrl}
