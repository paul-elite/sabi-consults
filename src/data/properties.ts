...
export const properties: Property[] = [
  ...
  },
  {
    ...
    description: 'Well-maintained 3-bedroom flat available for rent in Jabi. The apartment features modern amenities, excellent natural lighting, and is located close to Jabi Lake Mall and other conveniences.',
    price: 4500000,
    ...
    features: ['Serviced', 'Furnished Option', 'Security', 'Generator', 'Water Supply'],
    status: 'available',
    featured: false,
  ...
  {
    id: '8',
    title: 'Office Space in Life Camp',
    description: 'Premium office space available for rent in Life Camp. Open-plan layout suitable for corporate offices, with options for customization. Building features modern facade, elevator access, and dedicated parking.',
    price: 15000000,
    priceLabel: 'Per Annum',
    type: 'rent',
    ...
    features: ['Open Plan', 'Elevator', 'Dedicated Parking', 'Reception Area', 'Conference Room'],
    status: 'available',
    featured: false,
